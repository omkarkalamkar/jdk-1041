...
class TMCOpStateMachine(Machine):
    ...
    **INIT_UNKNOWN**, **INIT_STANDBY**, **INIT_ON** and
    ...
    * **component_on**: the component has been switched on
    ...
    def __init__(self, callback=None, **extra_kwargs):
        ...
        transitions = [
            ...
            {
                "source": ["DISABLE", "UNKNOWN", "STANDBY", "ON", "FAULT"],
                "trigger": "component_disconnected",
                "dest": "DISABLE",
            },
            {
            ...
            # TODO: What does these transitions mean?
            {
                "source": "FAULT",
