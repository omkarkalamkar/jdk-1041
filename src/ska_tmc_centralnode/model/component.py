...
#         self.healthState = dev_info.healthState
...
#     def from_dev_info(self, subarraydev_info):
#         super().from_dev_info(subarraydev_info)
#         if isinstance(subarraydev_info, SubArrayDeviceInfo):
#             self.id = subarraydev_info.id
#             self.resources = subarraydev_info.resources
#             self.obsState = subarraydev_info.obsState
