...
autodoc_mock_imports = ['PyTango', 'tango', 'tango.server', 'run', 'DeviceMeta', 'command',
                ...
                'marshmallow', 'ska.cdm.messages', 'ska.cdm.schemas',
...
latex_documents = [
    (master_doc, 'CentralNodemid.tex', 'Central Node Mid Documentation',
     'NCRA India', 'manual'),
]
...
man_pages = [
    (master_doc, 'centralnodemid', 'Central Node Mid Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Centralnodemid', 'Central Node Mid Documentation',
     author, 'centralnodemid', 'One line description of project.',
     'Miscellaneous'),
]
