...
python3 -m pip install --index-url https://artefact.skao.int/repository/pypi-internal/simple ska-ser-logging==0.4.0 ska-tmc-cdm==6.0.0 ska-tmc-common==0.1.7+d39e6423 ska-tango-base==0.11.3
