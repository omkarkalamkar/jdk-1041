...
@given("a TANGO ecosystem with a set of devices deployed", target_fixture="device_list")
def device_list():
    db = Database()
    return db.get_device_exported("*")


@given(parsers.parse("a CentralNode device called <central_node_name>"), target_fixture="central_node")
