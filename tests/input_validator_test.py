...
class TestAssignResourceValidator:
    ...
    def test_validate_good_json(self):
        ...
        output_config = input_validator.loads(json.dumps(assign_input_file))
        assert output_config == assign_input_file
