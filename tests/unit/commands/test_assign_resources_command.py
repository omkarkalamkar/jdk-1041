...
def test_telescope_assign_resources_command_missing_transaction_id(tango_context):
    logger.info("%s", tango_context)
    # import debugpy; debugpy.debug_this_thread()
    assign_res_command, _ = get_assign_resources_command_obj()
...
def test_telescope_assign_resources_command_missing_receptor_ids(tango_context):
    logger.info("%s", tango_context)
    # import debugpy; debugpy.debug_this_thread()
    assign_res_command, _ = get_assign_resources_command_obj()
