...
class HelperMCCSStateDevice(SKABaseDevice):
    ...
    def AssignResources(self, argin):
        tmpDict = {"interface":"https://schema.skatelescope.org/ska-low-mccs-assignedresources/1.0","subarray_beam_ids":[1],"station_ids":[[1,2]],"channel_blocks":[3]}
    ...
    def ReleaseResources(self, argin):
        tmpDict = {"interface":"https://schema.skatelescope.org/ska-low-mccs-assignedresources/1.0","subarray_beam_ids":[],"station_ids":[],"channel_blocks":[],}
        self._assigned_resources = json.dumps(tmpDict)
        return [[ResultCode.OK], [""]]
